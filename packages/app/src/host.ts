...
export function makeHostContext(store: Store, transport: EngineTransport, viewer: ViewerRef, host: HostCaps, scripts?: ScriptHost, results?: ResultsView, save: Autosave = autosave, captureEnvironment: AnimationCaptureEnvironment = browserAnimationCaptureEnvironment()): HostContext {
