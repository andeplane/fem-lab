...
import type { Ack, Capabilities, Command, Converted, CostEstimate, FrameResult, FramesResult, JournalDiff, JournalDump, MaterialLibrary, MeshSummary, ModelSummary, ObjectDefinition, ObjectList, PathResult, ProbeResult, Query, ReportText, ResultField, ResultSummary, RetainedResults, ScriptText, SetInfo } from './engine';
