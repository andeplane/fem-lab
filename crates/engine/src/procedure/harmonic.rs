...
//! The Benchmarks gate both ends — F5 is one degree of freedom, where the basis is complete and
//! superposition is exact, and F6 puts a cantilever's peak on an independent beam frequency.
